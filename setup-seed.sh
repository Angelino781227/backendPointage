#!/bin/bash
# Ajoute le script de seed (donnees fictives) au projet
...
if ! grep -q '"seed"' package.json; then
  # Insere les scripts seed juste apres la ligne "dev"
  sed -i.bak '/"dev":/a\
    "seed": "node seed.js",\
...
echo ""
echo "Script de seed cree avec succes !"
echo "Utilisation :"
echo "  npm run seed          -> insere les donnees fictives"
